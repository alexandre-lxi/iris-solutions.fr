...
<header id="home" class="header">
	...
	<div class="container">
		...
		<!-- HEADING -->
		<h1 class="intro">Le service informatique spécialisé pour les petites entreprises</h1>
        ...
        <div class="row bottom-message-section">
			<div class="col-lg-4 col-sm-4">
				<div class="short-text">
					<i class="icon icon-fontawesome-webfont-358"></i> Solutions à la demande
				</div>
			</div>
			<div class="col-lg-4 col-sm-4">
				<div class="short-text">
					<i class="icon-fontawesome-webfont-286"></i> Un seul contact pour vous répondre
				</div>
			</div>
			<div class="col-lg-4 col-sm-4">
				<div class="short-text">
					<i class="icon-fontawesome-webfont-347"></i> Satisfaction garantie
				</div>
			</div>
		</div>
